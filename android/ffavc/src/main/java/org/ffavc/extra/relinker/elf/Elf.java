...
package org.ffavc.extra.relinker.elf;
...
public interface Elf {
    abstract class Header {
        ...
        abstract public org.ffavc.extra.relinker.elf.Elf.ProgramHeader getProgramHeader(long index) throws IOException;
        abstract public org.ffavc.extra.relinker.elf.Elf.DynamicStructure getDynamicStructure(long baseOffset, int index)
                throws IOException;
    }
